define([], function() {
	...
	date.add = function(/* Date */date, /* String */interval, /* int */amount) {
		...
		var sum = new Date(+date); // convert to Number before copying to
									// accomodate IE (#3112)
		...
		case "day":
			break;
		case "weekday":
			// i18n FIXME: assumes Saturday/Sunday weekend, but this is not
			// always true. see dojo/cldr/supplemental
	...
	// Don't use setObject() because it may overwrite dojo/date/stamp (if that
