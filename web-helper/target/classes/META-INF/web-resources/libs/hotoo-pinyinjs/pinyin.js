/**
 * reference https://github.com/hotoo/pinyin.js
 */
/*
 * usage：
pinyin("重点,出来", {
...
var dict_combo = {
  ...
  var dict_uncomboed = null;
  var getDictMap = function(){
	  if(dict_uncomboed == null){
		  dict_uncomboed = buildPinyinCache(dict_combo);
		  delete dict_combo;
	  }
	  return dict_uncomboed;
  }
  ...
  function single_pinyin(han, options){
    ...
    var dict_map = getDictMap();
    if(!dict_map.hasOwnProperty(han)){return [han];}
    var pys = dict_map[han].split(",");
  ...
  window.PINYIN_STYLE = PINYIN_STYLE;
  DEFAULT_OPTIONS.style= PINYIN_STYLE.NORMAL;
})();
